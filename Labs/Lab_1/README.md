...
### Часть 1. Знакомство с редактором Visual Studio Code
...
### Часть 3. Пишем программу мигания светодиодом на основе фреймворка CMSIS 
...
### Часть 4. Исследование кода программы и библиотеки CMSIS
...
### Часть 6. Загрузка программы в память микроконтроллера
